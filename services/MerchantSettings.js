...
const DEFAULTS = {
  ...
  liveOrderTicker: {
    enabled: false,
    randomMode: true,
    names: ["أحمد", "سارة", "محمد", "نورة", "خالد", "فاطمة", "عبدالله", "ريم", "يوسف", "هند", "ماجد", "لمى"],
    cities: ["الرياض", "جدة", "الدمام", "مكة", "الخبر", "المدينة المنورة", "الطائف", "تبوك", "أبها"],
    template: "🛍️ {name} من {city} اشترى منذ {time}",
    minMinutesAgo: 1,
    maxMinutesAgo: 45,
    messages: [
      "🛍️ أحمد من الرياض اشترى منذ 3 دقائق",
      "🛍️ سارة من جدة اشترت منذ 7 دقائق",
    ],
    position: "bottom-left",
    showEvery: 12000,
    bgColor: "#FFFFFF",
